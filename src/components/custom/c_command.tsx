...
function CustomCommand({
    ...
    return (
        <CommandPrimitive
            data-slot="command"
            className={cn(
                "bg-card text-foreground flex h-full w-full flex-col overflow-hidden rounded-md",
                className
            )}
            {...props}
        />
...
function CustomCommandDialog({
    ...
    ...props
}: React.ComponentProps<typeof CustomDialog> & {
    title?: string;
    description?: string;
    className?: string;
    ...
    return (
        <CustomDialog {...props}>
            <CustomDialogHeader className="sr-only">
            ...
            >
                <CustomCommand className="[&_[cmdk-group-heading]]:text-muted-foreground **:data-[slot=command-input-wrapper]:h-12 [&_[cmdk-group-heading]]:px-2 [&_[cmdk-group-heading]]:font-medium [&_[cmdk-group]]:px-2 [&_[cmdk-group]:not([hidden])_~[cmdk-group]]:pt-0 [&_[cmdk-input-wrapper]_svg]:h-5 [&_[cmdk-input-wrapper]_svg]:w-5 [&_[cmdk-input]]:h-12 [&_[cmdk-item]]:px-2 [&_[cmdk-item]]:py-3 [&_[cmdk-item]_svg]:h-5 [&_[cmdk-item]_svg]:w-5">
                    {children}
                </CustomCommand>
            </CustomDialogContent>
        </CustomDialog>
...
function CustomCommandGroup({
    ...
    return (
        <CommandPrimitive.Group
            ...
            className={cn(
                "text-foreground [&_[cmdk-group-heading]]:text-muted-foreground overflow-hidden p-2 [&_[cmdk-group-heading]]:px-2 [&_[cmdk-group-heading]]:py-1.5 [&_[cmdk-group-heading]]:text-xs [&_[cmdk-group-heading]]:font-medium",
                className
            )}
            {...props}
        />
...
function CustomCommandSeparator({
    className,
    ...props
...
function CustomCommandShortcut({
    className,
    ...props
