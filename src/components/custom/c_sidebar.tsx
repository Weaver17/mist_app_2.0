...
import {
    ...
    CustomSheetHeader,
    CustomSheetTitle,
} from "@/components/custom/c_sheet";
import { CustomSkeleton } from "@/components/custom/c_skeleton";
import {
    CustomTooltip,
    CustomTooltipContent,
    CustomTooltipProvider,
    CustomTooltipTrigger,
} from "@/components/custom/c_tooltip";
...
type CustomSidebarContextProps = {
...
const CustomSidebarContext =
    React.createContext<CustomSidebarContextProps | null>(null);
...
function CustomSidebarProvider({
    ...
    const contextValue = React.useMemo<CustomSidebarContextProps>(
        () => ({
            state,
            open,
            setOpen,
    ...
    return (
        <CustomSidebarContext.Provider value={contextValue}>
            <CustomTooltipProvider delayDuration={0}>
                <div
        ...
        return (
            ...
            >
                <CustomSheetContent
                    ...
                    side={side}
                >
                    <CustomSheetHeader className="sr-only">
                        <CustomSheetTitle>Sidebar</CustomSheetTitle>
                        <CustomSheetDescription>
...
function CustomSidebarTrigger({
    ...
    const { toggleCustomSidebar } = useCustomSidebar();
...
function CustomSidebarHeader({
    ...
    return (
        <div
            ...
            data-sidebar="header"
            className={cn("flex flex-col gap-2 p-2 font-semibold", className)}
            {...props}
        />
    );
}
...
function CustomSidebarSeparator({
    ...
    return (
        <CustomSeparator
            ...
            className={cn("bg-sidebar-border mx-1 w-auto", className)}
            {...props}
        />
    );
}
...
function CustomSidebarMenuButton({
    ...
    asChild?: boolean;
    isActive?: boolean;
    tooltip?: string | React.ComponentProps<typeof CustomTooltipContent>;
    ...
    return (
        <CustomTooltip>
            <CustomTooltipTrigger asChild>{button}</CustomTooltipTrigger>
            <CustomTooltipContent
                side="right"
                align="center"
