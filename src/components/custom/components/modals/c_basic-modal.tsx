        ...
        <AnimatePresence>
            {isOpen && (
                <>
                    ...
                    <motion.div
                        ref={overlayRef}
                        className="bg-zinc-950/50 dark:bg-zinc-950/80 fixed inset-0 z-40 backdrop-blur-sm"
                        initial={{ opacity: 0 }}
                        animate={{ opacity: 1 }}
                        exit={{ opacity: 0 }}
                    ...
                    >
                        <motion.div
                            ref={modalRef}
                            className={`${modalSizes[size]} bg-card relative mx-auto w-full rounded-xl border p-4 shadow-xl sm:p-6`}
                        ...
                        >
                            ...
                            <div className="mb-4 flex items-center justify-between">
                                ...
                                <motion.button
                                    className="hover:bg-secondary/50 cursor-pointer ml-auto rounded-full p-1.5 transition-colors"
                                    onClick={onClose}
