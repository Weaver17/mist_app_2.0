...
function CustomDrawerTrigger({
    ...props
}: React.ComponentProps<typeof DrawerPrimitive.Trigger>) {
    return <DrawerPrimitive.Trigger data-slot="drawer-trigger" {...props} />;
}

function CustomDrawerPortal({
    ...props
...
function CustomDrawerOverlay({
    ...
    return (
        <DrawerPrimitive.Overlay
            ...
            className={cn(
                "data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 fixed inset-0 z-50 bg-zinc-950/70",
                className
            )}
            {...props}
        />
...
function CustomDrawerContent({
    ...
    return (
        <CustomDrawerPortal data-slot="drawer-portal">
            <CustomDrawerOverlay />
            <DrawerPrimitive.Content
                ...
                {...props}
            >
                <div className="bg-muted-foreground mx-auto mt-4 hidden h-2 w-30 shrink-0 rounded-full group-data-[vaul-drawer-direction=bottom]/drawer-content:block" />
                {children}
            </DrawerPrimitive.Content>
        </CustomDrawerPortal>
    );
...
function CustomDrawerDescription({
    className,
    ...props
