...
function CustomContextMenuTrigger({
    ...props
...
function CustomContextMenuGroup({
    ...props
...
function CustomContextMenuPortal({
    ...props
...
function CustomContextMenuSub({
    ...props
}: React.ComponentProps<typeof ContextMenuPrimitive.Sub>) {
    return <ContextMenuPrimitive.Sub data-slot="context-menu-sub" {...props} />;
}

function CustomContextMenuRadioGroup({
    ...props
...
function CustomContextMenuSubTrigger({
    className,
    inset,
    children,
    ...props
...
function CustomContextMenuSubContent({
    className,
    ...props
...
function CustomContextMenuCheckboxItem({
    className,
    children,
    checked,
    ...props
...
function CustomContextMenuRadioItem({
    className,
    children,
    ...props
...
function CustomContextMenuLabel({
    className,
    inset,
    ...props
...
function CustomContextMenuSeparator({
    className,
    ...props
...
function CustomContextMenuShortcut({
    className,
    ...props
